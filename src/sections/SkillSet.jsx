...
const skills = [
  ...
  { name: "TypeScript", level: 20, color: "from-blue-500 to-blue-700", icon: "assets/logos/typescript.svg" },
  { name: "React", level: 90, color: "from-cyan-400 to-blue-500", icon: "assets/logos/react.svg" },
  { name: "Next.js", level: 30, color: "from-slate-700 to-black", icon: "assets/logos/next-js.svg" },
            ...
            {skills.map((skill, index) => (
              ...
              >
                ...
                <div
                  ...
                  className="relative w-full bg-neutral-800/60 backdrop-blur-sm rounded-full h-3 sm:h-4 border border-neutral-700/30"
                >
                  <div
