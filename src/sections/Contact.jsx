...
//       // Combine all fields into the message for backend compatibility
//       const contactData = {
//         name: formData.name,
...
${formData.message}`
  ...
  <div className="flex flex-col items-center justify-center max-w-2xl p-8 mx-auto border border-white/10 rounded-3xl bg-primary/80 backdrop-blur-sm shadow-2xl">
    {/* Header Section */}
